...
class UserProfilePresenter {
    ...
    private func logOut() {
        ...
        let alertControllet = AlertControllerMaker.makeAlertWithCancel(alertTitleText, alertMessageText, style: .alert, okTitleText, cancelTitleText, handler: { [weak self] okAction in
